...
const Hero = () => {
  ...
  // Removed the mousemove event listener that was causing sideways movement
      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-8 items-center relative z-10">
        ...
        >
          ...
          >
            ...
            <br />
            <span className="text-theme-light">Rahul Rajasekharan Menon</span>
          </motion.h1>
          <motion.p 
        ...
        >
          <motion.div 
            className="relative"
            whileHover={{ scale: 1.1 }} // Increased zoom effect on hover
          ...
          >
            ...
            <div className="relative rounded-full overflow-hidden border-4 border-theme-dark h-64 w-64 md:h-80 md:w-80 shadow-xl">
              <motion.img
                src="/lovable-uploads/b70d0b05-44cd-4063-a402-e3699b5abd09.png"
                alt="Profile Image"
                className="w-full h-full object-cover"
                initial={{ scale: 1.0 }}
                whileHover={{ scale: 1.15 }} // Added zoom effect to the image itself
